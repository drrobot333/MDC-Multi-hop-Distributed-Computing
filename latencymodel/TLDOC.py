def cal_total_latency(off_tensor, time_config, network_info, data_size_list, t_wait):
...
def cal_total_latency_except_end(off_tensor, time_config, network_info, data_size_list, t_wait):
    #%
